      ...
      <ScrollView>
        ...
        <View style={styles.stepContainer}>
          <View style={styles.btnGroup}>
            <TouchableOpacity
              style={[styles.btn, styles.selected]}>
              <Text style={styles.selectedbtnTxt} onPress={() => navigation.navigate('Worker')}>Arbeitnehmer</Text>
            </TouchableOpacity>
          ...
          <View style={styles.item}>
            ...
            <Text style={styles.stepDesc}>Erstellen dein Lebenslauf</Text>
          </View>
          <View style={styles.step2}>
            <ImageBackground source={require('../assets/back.png')} style={styles.stepImg}>
              ...
              <Image source={require('../assets/task.png')} style={styles.profileImg} />
            </ImageBackground>
          </View>
          <View style={styles.step2}>
            <View style={styles.item}>
              <Text style={styles.number}>3.</Text>
              <Text style={styles.stepDesc}>Mit nur einem Klick bewerben</Text>
            </View>
