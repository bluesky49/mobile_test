      ...
      <ScrollView>
        ...
        <View style={styles.stepContainer}>
          <View style={styles.btnGroup}>
            ...
            <TouchableOpacity style={[styles.btn, styles.selected]} onPress={() => navigation.navigate('Employer')}>
              <Text style={styles.selectedbtnTxt}>Arbeitgeber</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('Office')}>
              <Text
                style={[styles.btnTxt, { borderTopRightRadius: 12, borderBottomRightRadius: 12 }]}
              >
                Temporärbüro
              </Text>
            </TouchableOpacity>
          ...
          <View style={styles.step2}>
            ...
            <Text style={styles.stepDesc}>Erstellen ein Jobinserat</Text>
            </View>
            <Image source={require('../assets/about.png')} style={styles.aboutImg} />
            </ImageBackground>
          </View>
          <View style={styles.step2}>
            <View style={styles.item}>
            <Text style={styles.number}>3.</Text>
            <Text style={styles.stepDesc}>Wähle deinen{"\n"}neuen Mitarbeiter aus</Text>
            </View>
            <Image source={require('../assets/swipe.png')} style={styles.aboutImg} />
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
